...
import com.example.hatio.things_rtls.calibration.activity.ResultsActivity;
import com.example.hatio.things_rtls.calibration.activity.SettingsActivity;
import com.example.hatio.things_rtls.calibration.managers.CameraCalibrator;
import com.example.hatio.things_rtls.calibration.managers.CameraManager;
import com.example.hatio.things_rtls.calibration.utils.ImageUtils;
import com.example.hatio.things_rtls.calibration.views.AutoFitTextureView;
...
public class Calibration extends AppCompatActivity {
    ...
    public final static ImageReader.OnImageAvailableListener imageAvailableListener = new ImageReader.OnImageAvailableListener() {
        ...
        public void onImageAvailable(ImageReader ir) {
            ...
            Calibration.camera2View.setImageBitmap(bitmap);
